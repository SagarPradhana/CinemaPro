      ...
      <div className="relative pt-20 pb-12 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <div>
              <h1 className="text-5xl lg:text-6xl font-display font-black text-[#1A1510] tracking-tighter uppercase leading-none">Binge Hub</h1>
              <p className="text-[#8A7A65] font-medium mt-2 tracking-[0.1em] uppercase text-[11px] font-black">Binge-worthy shows and global series</p>
            </div>
          </motion.div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        {loading ? (
          ...
          <div className="py-40 text-center">
            ...
            <h3 className="mt-8 text-3xl font-display font-black text-[#1A1510]">No series found</h3>
          </div>
        ) : (
          <>
            <div className="grid grid-cols-2 gap-10 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-5">
              {items.map((series) => (
                <ContentCard key={series._id} data={series} type={selectedType === 'all' ? 'series' : selectedType as any} />
              ))}
            </div>
            {totalPages > 1 && (
