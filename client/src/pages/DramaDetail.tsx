        ...
        {series.seasons.length > 0 && (
          <div className="py-32 border-t border-[#E8DDD0]">
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-16">
              <div>
                <h2 className="text-4xl font-display font-black text-[#1A1510] mb-4 tracking-tighter">Episode Gallery</h2>
                <p className="text-[#8A7A65] font-medium uppercase tracking-[0.2em] text-[10px] font-black">Select a chapter to begin</p>
              </div>
                    ...
                    <div className="relative rounded-3xl overflow-hidden bg-white border border-[#E8DDD0] p-4 transition-all duration-500 hover:shadow-2xl hover:border-[#B8892A]/30">
                      <div className="relative aspect-video overflow-hidden rounded-2xl mb-6">
                        {episode.thumbnailImage ? (
                          ...
                          <div className="flex h-full w-full items-center justify-center bg-[#F5F0E8]">
                            <Play className="h-8 w-8 text-[#B8892A]/20" />
                          </div>
                        )}
                      ...
                      <div>
                        ...
                        <h3 className="font-display font-bold text-lg text-[#1A1510] line-clamp-1">{episode.title || `Chapter ${episode.episodeNumber}`}</h3>
